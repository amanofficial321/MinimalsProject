        ...
        <div classnamename="row">
          <div classnamename="col-sm-12">
                ...
                <div className="container-fluid">
                  ...
                  <ul className="nav navbar-nav" style={{ float: "right" }}>
                    ...
                    <Link
                      ...
                      to="/Guest"
                    >
                      <li className="nav-item item3">Posts</li>
                    </Link>
                    ...
                    >
                      {" "}
                      <li className="nav-item item5">Log In</li>
                    </Link>
                    ...
                    >
                      {" "}
                      <li className="nav-item item6">Sign Up</li>
                    </Link>
                  </ul>
                </div>
              </nav>
            ...
            <video className="homepageimage" autoPlay loop muted>
              <source
                src="/images\video_AdobeExpress_AdobeExpress_AdobeExpress.mp4"
                type="video/mp4"
              />
            </video>
            <Zoom top duration={3000}>
              <div className="feautered col-sm-8">
                ...
                <img
                  className="feauteredimg"
                  src="images\2e2a49_e517229392d74f7498b1f7be7a78efee_mv2.webp"
                />
                <p className="feautered2">Dec 15 . 2 min</p>
                <p className="feautered3">Top Hikes In Australia</p>
                <p className="feautered4">
                  Create a blog post subtitle that summarizes your
                  <br />
                  post in s few short,punchy sentances and entices
                  <br />
                  your audiance to continue reading....
                </p>
            ...
            <div className="aboutusdiv">
              <Fade left>
                <p id="aboutus" className="homeaboutus">
                  About US
                </p>
                <p className="aboutusdiscription">
                  ...
                  <br />
                  bring you money has a very straightforward purpose – to rank
                  <br />
                  your website higher in Google SERPs, a.k.a. increase your
                  visibility.
                </p>
              </Fade>
              <Fade right>
            ...
            <p id="blog" className="homerecentpost">
              Recent Posts
            </p>
            ...
            <div className="homerecentpostdiv">
              <Rotate top left>
                <div className="homerecentpostdiv1">
                  ...
                  <p className="homerecentpostdiv1p1">
                    Maxico: A Gulinary
                    <br />
                    Journey
                  </p>
              ...
              <LightSpeed left>
                <div className="threecard1">
                  <p className="threecard1a">
                    "I've always found NerdWallet extremely
                    <br />
                    helpful when I've been looking for good
                    <br />
                    credit options and savings options! <br />
                    The information is very easy to understand!"
                  </p>
                  <b>John W.</b>
                </div>
              </LightSpeed>
            ...
            <div className="longwidth">
              <p>
                <span style={{ position: "relative", left: 40 }}>159</span>
                <br />
                Number Of Blogs
              </p>
              <p>
                <span style={{ position: "relative", right: 5 }}>646</span>
                <br />
                Likes
              </p>
              <p>
                <span style={{ position: "relative", left: 10 }}>485</span>
                <br />
                Comments
              </p>
              <p>
                <span style={{ position: "relative", left: 35 }}>645</span>
                <br />
                Recommendation
              </p>
            </div>
            <div id="footer" className="footer">
              ...
              <p className="footer4">
                Subscribe here and get the latest travel tips <br /> and my
                insider secrets!
              </p>
