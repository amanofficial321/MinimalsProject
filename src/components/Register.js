...
const Register = () => {
  ...
  const postUser = () => {
    ...
    fetch("http://35.90.113.221/register/", requestOptions)
        ...
        <div className="row">
          <div className="col-sm-4 div4 ">
            <div className="card signincard">
              ...
              <h1>
                <b>Manage the job more effectively with My App</b>
              </h1>
              <img
          ...
          <div className="col-sm-8  registerdiv8 ">
            <p className="registercreateaccount">
              Already have an account?{" "}
              <Link to="/Login">
                <b>
                  <span className="l" style={{ color: "#f45ca5" }}>
                    Login
                  </span>
                </b>
              </Link>
            ...
            <form onSubmit={validation}>
              <input
                type="text"
                className="form-control registerfname"
              ...
              {error && first_name.length <= 0 ? (
                <label className="fnamelabel">First Name Can't Be Empty.</label>
              ) : (
                ""
              )}
              ...
              <input
                type="text"
                className="form-control registerlname"
              ...
              {error && last_name.length <= 0 ? (
                <label className="lnamelabel">Last name can't be empty.</label>
              ) : (
                ""
              )}
              ...
              {error && email.length <= 0 ? (
                <label className="emaillabel"> Email can't be empty.</label>
              ) : (
                ""
              )}
              ...
              <button onClick={postUser} type="submit" className="submit">
