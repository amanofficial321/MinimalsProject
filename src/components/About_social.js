...
const About_social = () => {
  ...
  const postUser = () => {
    ...
    fetch("http://35.90.113.221/user_about/", requestOptions)
      .then((resp) => {
        if (resp) {
          console.log("About_social ", resp);
          alert("Successful");
          navigate("/About_social2");
        }
      })
      .catch((error) => {
        console.error(error);
